@extends('provider.layouts.app2')

@section('content')

<div class="login-register" style="background-image:url({{ asset('storage/images/gradienta.jpg') }});">        
  <div class="login-box card">
      <div class="card-header">{{ __('Login') }}</div>
  <div class="card-body">
      <form class="form-horizontal form-material" method="POST" action="{{ route('provider.login') }}" aria-label="{{ __('Login') }}">
          @csrf
