                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="sl-package">
                                    <div class="sl-package__title">
                                        <img src="{{ asset('storage/package/'.$package->image) }}" width="64" height="64" alt="Image Description">
                                        <h3>{{ $package->name }}</h3>
                                        <em>{{ $package->description }}</em>
                                    </div>
                                    <div class="sl-package__deal sl-bg-blue">
                                        <div class="sl-package__price">
                                            <h3><sup>MZN</sup>{{ $package->price }}</h3>
                                            {{-- <p>\ Month</p> --}}
                                        </div>
                                    ...
                                    <div class="sl-package__footer">
                                        <ul class="sl-package__details">
                                            <li>
                                                ...
                                                <p>{{ $package->duration }} {{ $package->uration_type }}</p>
                                            </li>

                                            @foreach(explode(',', $package->benefits) as $singleText)
                                                <li>
                                                    <p>{{$singleText}}</p>
