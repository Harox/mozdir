...
<body class="sl-home">
    ...
    <div class="preloader-outer">
        <div class="sl-preloader-holder">
            ...
            <img src="{{ asset('front/images/loader.png') }}" alt="loader img">
    ...
    <header>
        <div class="sl-main-header">
            <strong class="sl-main-header__logo">
               <a href="index.html"><img src="{{ asset('front/images/main-logo.png')}}" alt="Logo"></a>
            </strong>
                    ...
                    <div class="sl-topbar-notify">
                        ...
                        <div class="sl-topbar-notify__icons dropdown">
                            ...
                            <div class="dropdown-menu sl-dropdown__cart" aria-labelledby="slCart">
                                ...
                                <ul>
                                    <li>
                                        <img src="{{ asset('front/images/index/cart/img-01.png')}}" alt="Image Description">
                                    ...
                                    <li>
                                        <img src="{{ asset('front/images/index/cart/img-02.png')}}" alt="Image Description">
                                        <div class="sl-dropdown__cart__description">
                                    ...
                                    <li>
                                        <img src="{{ asset('front/images/index/cart/img-03.png')}}" alt="Image Description">
                                        <div class="sl-dropdown__cart__description">
                                                    ...
                                                    <div class="sl-productstab">
                                                        <div class="sl-viewproducts">
                                                            <figure class="sl-viewproducts__img">
                                                                <img src="{{ asset('front/images/img-02.jpg')}}" alt="img description">
                                                        ...
                                                        <div class="sl-productsinfo">
                                                            <div class="sl-dropdown__cart">
                                                                ...
                                                                <ul>
                                                                    ...
                                                                    <li>
                                                                        <img src="{{ asset('front/images/index/cart/img-04.png')}}" alt="Image Description">
                                                                        <div class="sl-dropdown__cart__description">
                                                                            <a class="sl-cart-title" href="javascript:void(0);">Earbuds Earphones Stereo</a>
                                                                            <span class="sl-cart-price">$11.19</span>
                                                                            <a class="sl-soldby" href="javascript:void(0);"><em>Sold by</em> Ryan &amp; John</a>
                                                                    ...
                                                                    <li>
                                                                        <img src="{{ asset('front/images/index/cart/img-05.png')}}" alt="Image Description">
                                                                        <div class="sl-dropdown__cart__description">
                                                                            <a class="sl-cart-title" href="javascript:void(0);">Vintage Round Sunglasses</a>
                                                                            <span class="sl-cart-price">$13.50</span>
                                                                    ...
                                                                    <li>
                                                                        <img src="{{ asset('front/images/index/cart/img-06.png')}}" alt="Image Description">
                                                                        <div class="sl-dropdown__cart__description">
                                                                            <a class="sl-cart-title" href="javascript:void(0);">Phone Holder for Car</a>
                                                                            <span class="sl-cart-price">$8.30</span>
                                                                            <a class="sl-soldby" href="javascript:void(0);"><em>Sold by</em> Crown Lost Group</a>
                                                    ...
                                                    <div class="sl-productstab">
                                                        ...
                                                        <div class="sl-productsinfo">
                                                            <div class="sl-dropdown__cart">
                                                                ...
                                                                <ul>
                                                                    <li>
                                                                        <img src="{{asset('front/images/index/cart/img-01.png')}}" alt="img description">
                                                                    ...
                                                                    <li>
                                                                        <img src="{{asset('front/images/index/cart/img-02.png')}}" alt="img description">
                                                                    ...
                                                                    <li>
                                                                        <img src="{{asset('front/images/index/cart/img-03.png')}}" alt="img description">
                                                                    ...
                                                                    <li>
                                                                        <img src="{{asset('front/images/index/cart/img-04.png')}}" alt="img description">
                                                                    ...
                                                                    <li>
                                                                        <img src="{{asset('front/images/index/cart/img-05.png')}}" alt="img description">
                                                                    ...
                                                                    <li>
                                                                        <img src="{{asset('front/images/index/cart/img-06.png')}}" alt="img description">
                                                                        <div class="sl-dropdown__cart__description">
                                                                            <a class="sl-cart-title" href="javascript:void(0);">Phone Holder for Car</a>
                                                                            <span class="sl-cart-price">$8.30</span>
                                                                            <a class="sl-soldby" href="javascript:void(0);"><em>Sold by</em> Crown Lost Group</a>
    ...
    <div class="sl-main-banner">
        <div id="slBannerOwl" class="owl-carousel owl-theme">
            <div class="item"><img src="{{ asset('front/images/index/main-banner/img-01.jpg')}}" alt="Image Description"></div>
            <div class="item"><img src="{{ asset('front/images/index/main-banner/img-02.jpg')}}" alt="Image Description"></div>
            <div class="item"><img src="{{ asset('front/images/index/main-banner/img-03.jpg')}}" alt="Image Description"></div>
            <div class="item"><img src="{{ asset('front/images/index/main-banner/img-04.jpg')}}" alt="Image Description"></div>
            <div class="item"><img src="{{ asset('front/images/index/main-banner/img-05.jpg')}}" alt="Image Description"></div>
            <div class="item"><img src="{{ asset('front/images/index/main-banner/img-06.jpg')}}" alt="Image Description"></div>
            <div class="item"><img src="{{ asset('front/images/index/main-banner/img-07.jpg')}}" alt="Image Description"></div>
            <div class="item"><img src="{{ asset('front/images/index/main-banner/img-08.jpg')}}" alt="Image Description"></div>
        </div>
        <div class="sl-main-banner__content">
            ...
            <img src="{{ asset('front/images/index/main-banner/img-01.png')}}" alt="Image Description">
        </div>
    </div>
    <!-- BANNER END -->
    <!-- MAIN START -->
        ...
        <section class="sl-main-section">
            <div class="container">
                ...
                <div class="sl-category sl-row">
                    ...
                    <div class="sl-col sl-col-sm-1-of-2 sl-col-md-1-of-3 sl-col-lg-1-of-4 sl-col-xl-1-of-5">
                        <div class="sl-category__service">
                            <img src="{{ asset('front/images/index/category/img-03.jpg')}}" alt="image Description">
                            <div class="sl-category__description">
                                <h5>Networking</h5>
                    ...
                    <div class="sl-col sl-col-sm-1-of-2 sl-col-md-1-of-3 sl-col-lg-1-of-4 sl-col-xl-1-of-5">
                        <div class="sl-category__service">
                            <img src="{{ asset('front/images/index/category/img-04.jpg')}}" alt="image Description">
                            <div class="sl-category__description">
                                <h5>Plumbing</h5>
                    ...
                    <div class="sl-col sl-col-sm-1-of-2 sl-col-md-1-of-3 sl-col-lg-1-of-4 sl-col-xl-1-of-5">
                        <div class="sl-category__service">
                            <img src="{{ asset('front/images/index/category/img-05.jpg')}}" alt="image Description">
                            <div class="sl-category__description">
                    ...
                    <div class="sl-col sl-col-sm-1-of-2 sl-col-md-1-of-3 sl-col-lg-1-of-4 sl-col-xl-1-of-5">
                        <div class="sl-category__service">
                            <img src="{{ asset('front/images/index/category/img-06.jpg')}}" alt="image Description">
                            <div class="sl-category__description">
                                <h5>Law & Finance</h5>
                    ...
                    <div class="sl-col sl-col-sm-1-of-2 sl-col-md-1-of-3 sl-col-lg-1-of-4 sl-col-xl-1-of-5">
                        <div class="sl-category__service">
                            <img src="{{ asset('front/images/index/category/img-07.jpg')}}" alt="image Description">
                            <div class="sl-category__description">
                                <h5>Medical</h5>
                    ...
                    <div class="sl-col sl-col-sm-1-of-2 sl-col-md-1-of-3 sl-col-lg-1-of-4 sl-col-xl-1-of-5">
                        <div class="sl-category__service">
                            <img src="{{ asset('front/images/index/category/img-08.jpg')}}" alt="image Description">
                            <div class="sl-category__description">
                    ...
                    <div class="sl-col sl-col-sm-1-of-2 sl-col-md-1-of-3 sl-col-lg-1-of-4 sl-col-xl-1-of-5">
                        <div class="sl-category__service">
                            <img src="{{ asset('front/images/index/category/img-09.jpg')}}" alt="image Description">
                            <div class="sl-category__description">
                    ...
                    <div class="sl-col sl-col-sm-1-of-2 sl-col-md-1-of-3 sl-col-lg-1-of-4 sl-col-xl-1-of-5">
                        <div class="sl-category__service">
                            <img src="{{ asset('front/images/index/category/img-10.jpg')}}" alt="image Description">
                            <div class="sl-category__description">
        ...
        <section class="sl-main-section">
            ...
            <div id="slCategoryOwl" class="owl-carousel owl-theme sl-owl-nav">
                <div class="item">
                    <div class="sl-slider">
                        <figure>
                            <a href="javascript:void(0);"><img src="{{ asset('front/images/index/service-provider/img-01.jpg')}}" alt="Image Description"></a>
                            <a href="javascript:void(0);"><img src="{{ asset('front/images/index/service-provider/user-icon/img-01.jpg')}}" alt="Image Description"></a>
                ...
                <div class="item">
                    <div class="sl-slider">
                        <figure>
                            <a href="javascript:void(0);"><img src="{{ asset('front/images/index/service-provider/img-02.jpg')}}" alt="Image Description"></a>
                            <a href="javascript:void(0);"><img src="{{ asset('front/images/index/service-provider/user-icon/img-02.jpg')}}" alt="Image Description"></a>
                           <a href="javascript:void(0);" class="sl-like"><i class="far fa-heart"></i></a>
                        </figure>
                        <div class="sl-slider__content">
                            <div class="sl-slider__header">
                ...
                <div class="item">
                    <div class="sl-slider">
                        <figure>
                            <a href="javascript:void(0)"><img src="{{ asset('front/images/index/service-provider/img-03.jpg')}}" alt="Image Description"></a>
                            <a href="javascript:void(0)"><img src="{{ asset('front/images/index/service-provider/user-icon/img-03.jpg')}}" alt="Image Description"></a>
                ...
                <div class="item">
                    <div class="sl-slider">
                        <figure>
                            <a href="javascript:void(0);"><img src="{{ asset('front/images/index/service-provider/img-04.jpg')}}" alt="Image Description"></a>
                            <a href="javascript:void(0);"><img src="{{ asset('front/images/index/service-provider/user-icon/img-04.jpg')}}" alt="Image Description"></a>
                            <a href="javascript:void(0);" class="sl-like sl-liked"><i class="far fa-heart"></i></a>
                        </figure>
                        <div class="sl-slider__content">
                            <div class="sl-slider__header">
                ...
                <div class="item">
                    <div class="sl-slider">
                        <figure>
                            <a href="javascript:void(0);"><img src="{{ asset('front/images/index/service-provider/img-05.jpg')}}" alt="Image Description"></a>
                            <a href="javascript:void(0);"><img src="{{ asset('front/images/index/service-provider/user-icon/img-05.jpg')}}" alt="Image Description"></a>
                            <a href="javascript:void(0);" class="sl-like"><i class="far fa-heart"></i></a>
                        </figure>
                        <div class="sl-slider__content">
                            <div class="sl-slider__header">
                ...
                <div class="item">
                    <div class="sl-slider">
                        <figure>
                            <a href="javascript:void(0);"><img src="{{ asset('front/images/index/service-provider/img-06.jpg')}}" alt="Image Description"></a>
                            <a href="javascript:void(0);"><img src="{{ asset('front/images/index/service-provider/user-icon/img-06.jpg')}}" alt="Image Description"></a>
                            <a href="javascript:void(0);" class="sl-like"><i class="far fa-heart"></i></a>
                        </figure>
                        <div class="sl-slider__content">
                            <div class="sl-slider__header">
                ...
                <div class="sl-packagePlan">
                    <div class="row">
                        <div class="col-md-6 col-xl-4">
                            <div class="sl-package">
                                <div class="sl-package__title">
                                    <img src="{{ asset('front/images/index/packages/img-01.jpg')}}" alt="Image Description">
                                    <h3>Basic Plan</h3>
                        ...
                        <div class="col-md-6 col-xl-4">
                            <div class="sl-package">
                                <div class="sl-package__title">
                                    <img src="{{ asset('front/images/index/packages/img-02.jpg')}}" alt="Image Description">
                                    <h3>Standard</h3>
                ...
                <div class="container">
                    ...
                    <div id="slFeedbackOwl" class="owl-carousel owl-theme">
                        <div class="item">
                            <div class="sl-feedback">
                                <div class="sl-feedback__title">
                                    <img src="{{ asset('front/images/index/feedback/user-icon/img-01.jpg')}}" alt="Image Description">
                        ...
                        <div class="item">
                            <div class="sl-feedback">
                                <div class="sl-feedback__title">
                                    <img src="{{ asset('front/images/index/feedback/user-icon/img-02.jpg')}}" alt="Image Description">
                                    <div class="sl-feedback__title__text">
                                        <h5>Stuart Loney</h5>
                                        <p><em>New york</em></p>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="sl-featuredProducts--post">
                                <figure>
                                    <img src="{{ asset('front/images/index/featured-products/img-01.jpg')}}" alt="Image Description">
                                    <figcaption>
                                        <div class="sl-slider__tags">
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="sl-featuredProducts--post">
                                <figure>
                                    <img src="{{ asset('front/images/index/featured-products/img-02.jpg')}}" alt="Image Description">
                                    <figcaption>
                                        <div class="sl-slider__tags">
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="sl-featuredProducts--post">
                                <figure>
                                    <img src="{{ asset('front/images/index/featured-products/img-03.jpg')}}" alt="Image Description">
                                    <figcaption>
                                        <div class="sl-slider__tags">
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="sl-featuredProducts--post">
                                <figure>
                                    <img src="{{ asset('front/images/index/featured-products/img-04.jpg')}}" alt="Image Description">
                                    <figcaption>
                                        <div class="sl-slider__tags">
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="sl-featuredProducts--post">
                                <figure>
                                    <img src="{{ asset('front/images/index/featured-products/img-05.jpg')}}" alt="Image Description">
                                    <figcaption>
                                        <div class="sl-slider__tags">
                                            <span class="sl-bg-red-orange">25% OFF</span>
                                        </div>
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="sl-featuredProducts--post">
                                <figure>
                                    <img src="{{ asset('front/images/index/featured-products/img-06.jpg')}}" alt="Image Description">
                                    <figcaption>
                                        <div class="sl-slider__tags">
                                            <span class="sl-bg-red-orange">25% OFF</span>
                                        </div>
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="sl-featuredProducts--post">
                                <figure>
                                    <img src="{{ asset('front/images/index/featured-products/img-07.jpg')}}" alt="Image Description">
                                    <figcaption>
                                        <div class="sl-slider__tags">
                                            <span class="sl-bg-red-orange">50% OFF</span>
                                        </div>
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="sl-featuredProducts--post">
                                <figure>
                                    <img src="{{ asset('front/images/index/featured-products/img-08.jpg')}}" alt="Image Description">
                                    <figcaption>
                                        <div class="sl-slider__tags">
                                            <span class="sl-bg-red-orange">12% OFF</span>
                                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-lg-4 col-xl-3">
                        <ul class="sl-footerUpper__flags">
                            ...
                            <li>
                                <p><a href="javascript:void(0);"><img src="{{ asset('front/images/index/footer/flags/img-01.jpg')}}" alt="Image Description">New York</a></p>
                                <span>(58553)</span>
                            </li>
                            <li>
                                <p><a href="javascript:void(0);"><img src="{{ asset('front/images/index/footer/flags/img-02.jpg')}}" alt="Image Description">United Emirated</a></p>
                                <span>(85651)</span>
                            </li>
                            <li>
                                <p><a href="javascript:void(0);"><img src="{{ asset('front/images/index/footer/flags/img-03.jpg')}}" alt="Image Description">Rome</a></p>
                                <span>(45324)</span>
                            </li>
                            <li>
                                <p><a href="javascript:void(0);"><img src="{{ asset('front/images/index/footer/flags/img-04.jpg')}}" alt="Image Description">United Kingdom</a></p>
                                <span>(3255688)</span>
                            </li>
                            <li>
                                <p><a href="javascript:void(0);"><img src="{{ asset('front/images/index/footer/flags/img-05.jpg')}}" alt="Image Description">Canada</a></p>
                                <span>(12456)</span>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="sl-footerCenter__logoSection">
                            <a href="javascript:void(0);"><img src="{{ asset('front/images/index/footer/footer-logo.png')}}" alt="Image Description"></a>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="sl-footerCenter__newsletter">
                            ...
                            <div class="sl-app">
                                <a href="javascript:void(0);"><img src="{{ asset('front/images/index/footer/app/img-01.jpg')}}" alt="Image Description"></a>
                                <a href="javascript:void(0);"><img src="{{ asset('front/images/index/footer/app/img-02.jpg')}}" alt="Image Description"></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="sl-footerLower__content">
                    ...
                    <ul class="sl-payments">
                        <li><a href="javascript:void(0);"><img src="{{ asset('front/images/index/footer/payments/img-01.jpg')}}" alt="Image Description"></a></li>
                        <li><a href="javascript:void(0);"><img src="{{ asset('front/images/index/footer/payments/img-02.jpg')}}" alt="Image Description"></a></li>
                        <li><a href="javascript:void(0);"><img src="{{ asset('front/images/index/footer/payments/img-03.jpg')}}" alt="Image Description"></a></li>
                        <li><a href="javascript:void(0);"><img src="{{ asset('front/images/index/footer/payments/img-04.jpg')}}" alt="Image Description"></a></li>
                        <li><a href="javascript:void(0);"><img src="{{ asset('front/images/index/footer/payments/img-05.jpg')}}" alt="Image Description"></a></li>
                        <li><a href="javascript:void(0);"><img src="{{ asset('front/images/index/footer/payments/img-06.jpg')}}" alt="Image Description"></a></li>
                    </ul>
                </div>
            </div>
        </div>
